...
function Home() {
  ...
  const [mesAnoSelecionadoText, setMesAnoSelecionadoText] = useState(format(new Date(ano, mes), "MMMM 'de' yyyy",{locale: pt}))
  ...
  return (
    <>
      ...
      <div className="">
        <div className="grid grid-cols-4 gap-6 sm:grid-cols-2 mb-6">
          <SelecionaData />
          <div className="">
            <select
              id="ano"
